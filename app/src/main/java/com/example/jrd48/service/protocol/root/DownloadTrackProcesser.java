...
public class DownloadTrackProcesser extends CommonProcesser {
    public final static String ACTION = "ACTION.DownloadTrackProcesser";
    private Context mContext;

    public DownloadTrackProcesser(Context context) {
        super(context);
        mContext = context;
    }
