...
public class ActionBarDataView2 extends FrameLayout {
    ...
    public ActionBarDataView2(Context context) {
        super(context);
        init(context);
    }

    public ActionBarDataView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public ActionBarDataView2(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    public ActionBarDataView2(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
